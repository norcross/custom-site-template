...
if [[ ! -f "${VVV_PATH_TO_SITE}/public_html/wp-content/mu-plugins/norcross-api-keys.php" ]]; then
  ...
  cp -a "${VVV_PATH_TO_SITE}/config/custom/mu-plugins/norcross-api-keys.php" "${VVV_PATH_TO_SITE}/public_html/wp-content/mu-plugins/norcross-api-keys.php"
fi
...
if [[ ! -f "${VVV_PATH_TO_SITE}/public_html/wp-content/mu-plugins/norcross-scratchpad.php" ]]; then
  ...
  # copy the file from local
  cp -a "${VVV_PATH_TO_SITE}/config/custom/mu-plugins/norcross-scratchpad.php" "${VVV_PATH_TO_SITE}/public_html/wp-content/mu-plugins/norcross-scratchpad.php"
fi
